...
# ~ print(monomial_list)
# ~ print(len(monomial_list)) # 33

# Use ncpol2sdpa to generate the monomials and the moment matrix for further processing
# ~ sdp.write_to_file("1sDIQKD_6statemeas.csv")    
sdp.save_monomial_index("1sDIQKD_6statemeas_monomials.txt") # 298+1 monomials




# Define the picos optimization problem	
monomial_dict = load_monomial_dict("1sDIQKD_6statemeas_monomials.txt")
# ~ print(monomial_dict)
...
for idx, V in enumerate(V_list):
    ...
    Score_cons = P.add_list_of_constraints([picos.trace(HermitianVars['rhoA']) == 1, \
                               picos.trace((A0 @ A0) * HermitianVars['B0']) == (1+3*V)/8, \
                               picos.trace(((I2-A0) @ A0) * HermitianVars['B0']) == (1-V)/8, \
                               picos.trace((A0 @ (I2-A0)) * HermitianVars['B0']) == (1-V)/8, \
                               picos.trace(((I2-A0) @ (I2-A0)) * HermitianVars['B0']) == (1-V)/8, \
                               picos.trace((A0 @ A0) * (HermitianVars['rhoA'] - HermitianVars['B0'])) == (1-V)/8, \
                               picos.trace(((I2-A0) @ A0) * (HermitianVars['rhoA'] - HermitianVars['B0'])) == (1-V)/8, \
                               picos.trace((A0 @ (I2-A0)) * (HermitianVars['rhoA'] - HermitianVars['B0'])) == (1-V)/8, \
                               picos.trace(((I2-A0) @ (I2-A0)) * (HermitianVars['rhoA'] - HermitianVars['B0'])) == (1+3*V)/8, \
                               picos.trace((A1 @ A1) * HermitianVars['B1']) == (1+V)/8, \
                               picos.trace(((I2-A1) @ A1) * HermitianVars['B1']) == (1-V)/8, \
                               picos.trace((A1 @ (I2-A1)) * HermitianVars['B1']) == (1-V)/8, \
                               picos.trace(((I2-A1) @ (I2-A1)) * HermitianVars['B1']) == (1+V)/8, \
                               picos.trace((A1 @ A1) * (HermitianVars['rhoA'] - HermitianVars['B1'])) == (1-V)/8, \
                               picos.trace(((I2-A1) @ A1) * (HermitianVars['rhoA'] - HermitianVars['B1'])) == (1+V)/8, \
                               picos.trace((A1 @ (I2-A1)) * (HermitianVars['rhoA'] - HermitianVars['B1'])) == (1+V)/8, \
                               picos.trace(((I2-A1) @ (I2-A1)) * (HermitianVars['rhoA'] - HermitianVars['B1'])) == (1-V)/8, \
                               picos.trace((A2 @ A2) * HermitianVars['B2']) == (1+V)/8, \
                               picos.trace(((I2-A2) @ A2) * HermitianVars['B2']) == (1-V)/8, \
                               picos.trace((A2 @ (I2-A2)) * HermitianVars['B2']) == (1-V)/8, \
                               picos.trace(((I2-A2) @ (I2-A2)) * HermitianVars['B2']) == (1+V)/8, \
                               picos.trace((A2 @ A2) * (HermitianVars['rhoA'] - HermitianVars['B2'])) == (1-V)/8, \
                               picos.trace(((I2-A2) @ A2) * (HermitianVars['rhoA'] - HermitianVars['B2'])) == (1+V)/8, \
                               picos.trace((A2 @ (I2-A2)) * (HermitianVars['rhoA'] - HermitianVars['B2'])) == (1+V)/8, \
                               picos.trace(((I2-A2) @ (I2-A2)) * (HermitianVars['rhoA'] - HermitianVars['B2'])) == (1-V)/8
    ])
